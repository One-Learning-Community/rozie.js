// Phase 16 SPEC R1/R5 runtime probe (D-05 runtime arm) — Solid target.
// NOTE: solid-vite's playwright.config.ts uses testDir: './tests' (no
// /e2e/ subdir); this file MUST live directly under tests/.
