 ...
 *   - port: react-vite's vite.config.ts uses dev port 5173 (shared with
 *     vue-vite); this config pins an isolated HMR dev port (5184) via `--port`
 *     so the HMR suites can run together without a collision.
 */
const HMR_PORT = 5184;
