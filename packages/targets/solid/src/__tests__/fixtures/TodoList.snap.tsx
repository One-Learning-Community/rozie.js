...
export default function TodoList(_props: TodoListProps): JSX.Element {
  ...
  return (
    ...
    <>
    <div {...attrs} class={"todo-list" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...attrs} data-rozie-s-52bec3de="">
