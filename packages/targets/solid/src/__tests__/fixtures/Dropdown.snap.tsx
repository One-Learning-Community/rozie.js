...
export default function Dropdown(_props: DropdownProps): JSX.Element {
  ...
  return (
    ...
    <>
    <div {...attrs} class={"dropdown" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...attrs} data-rozie-s-6d6bd882="">
