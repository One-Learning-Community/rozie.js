...
export default function Card(_props: CardProps): JSX.Element {
  ...
  return (
    ...
    <>
    <article {...attrs} class={"card" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...$listeners} data-rozie-s-a88c221e="">
