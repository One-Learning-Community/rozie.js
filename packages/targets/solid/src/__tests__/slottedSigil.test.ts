// quick 260807-cor (D4) Task 1 — `$slotted.<name>` Solid lowering.
//
// Solid has no shadow boundary — slot content is already a real light-DOM
...
describe('$slotted.<name> — Solid (quick 260807-cor D4)', () => {
