 ...
 *
 * Solid target — mirrors the React/Svelte/Lit per-target tests. See
...
describe('scopeCss (solid) — :deep() cross-component escape hatch', () => {
  ...
  it('plain rules unaffected — non-:deep selectors still scoped', () => {
    const out = scopeCss(
