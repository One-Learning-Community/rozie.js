 ...
 * `$props.x` / `$data.y` / `$refs.z` / `$emit` MUST clone first because Phase
 * 4 (React) and Phase 5 (Svelte/Angular) consume the SAME IR — mutating in
 * place would corrupt downstream targets in a multi-target build.
 *
