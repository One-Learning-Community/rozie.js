// quick 260807-cor (D4) Task 1 — `$slotted.<name>` Vue lowering.
//
// Vue has no shadow boundary — slot content is already a real light-DOM
...
describe('$slotted.<name> — Vue (quick 260807-cor D4)', () => {
