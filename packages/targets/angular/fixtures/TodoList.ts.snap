import { Component, ContentChild, ElementRef, Renderer2, TemplateRef, ViewEncapsulation, afterRenderEffect, computed, inject, input, model, output, signal, viewChild } from '@angular/core';
