// quick 260807-cor (D4) Task 1 — `$slotted.<name>` Angular lowering.
//
// Angular has no shadow boundary — slot content is already a real light-DOM
...
describe('$slotted.<name> — Angular (quick 260807-cor D4)', () => {
