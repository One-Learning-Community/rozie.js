/**
 * Quick task 260521-qsh — keyFilter predicate tests for @rozie/runtime-lit.
 *
 * Mirrors @rozie/runtime-react's keyFilter.test.ts: a `kbd()` factory builds a
 * KeyboardEvent and each of the 12 exported predicates is checked true-on-match
 * and false-on-miss so every function + branch is hit.
 */
...
describe('keyFilter predicates (runtime-lit)', () => {
