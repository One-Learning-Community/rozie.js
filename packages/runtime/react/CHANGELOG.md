...
- @rozie/runtime-keynav-core@0.7.4
...
- @rozie/runtime-keynav-core@0.7.2

## 0.7.1

### Patch Changes

- @rozie/runtime-keynav-core@0.7.1
...
- Array-form `:style` merge. `parseInlineStyle` now accepts an **array** of
  ...
  the same single-value logic. `Object.assign`-merges every element into
  one `CSSProperties` accumulator. This closed the `ROZ144` restriction —
  emitters are unchanged, the array literal already reached this helper at
