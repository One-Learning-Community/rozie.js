...
<div class="rozie-chart" style:height={height + 'px'} style:width={width ? width + 'px' : undefined} data-rozie-s-6680f000>
  
  <canvas bind:this={canvasEl} role="img" aria-label={ariaLabel} data-rozie-s-6680f000>{@render fallback?.()}</canvas>
</div>
