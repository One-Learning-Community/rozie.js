...
<div class="rozie-chart" style:height={height + 'px'} style:width={width ? width + 'px' : undefined} data-rozie-s-da10bb9e><canvas bind:this={canvasEl} role="img" aria-label={ariaLabel} data-rozie-s-da10bb9e>{@render fallback?.()}</canvas></div>
