...
<div class="rozie-chart" style:height={height + 'px'} style:width={width ? width + 'px' : undefined} data-rozie-s-e7b1d9e8>
  
  <canvas bind:this={canvasEl} role="img" aria-label={ariaLabel} data-rozie-s-e7b1d9e8>{@render fallback?.()}</canvas>
</div>
