...
<div class="rozie-chart" style:height={height + 'px'} style:width={width ? width + 'px' : undefined} data-rozie-s-4270cd12>
  
  <canvas bind:this={canvasEl} role="img" aria-label={ariaLabel} data-rozie-s-4270cd12>{@render fallback?.()}</canvas>
</div>
