...
@customElement('rozie-pie')
export default class Pie extends SignalWatcher(LitElement) {
  static styles = css`
.rozie-chart[data-rozie-s-d3ac8fdc] {
  position: relative;
  width: 100%;
}
...
private _portalContainers = new Set<HTMLElement>();
  ...
  render() {
    return html`
<div class="rozie-chart" style=${styleMap({ height: this.height + 'px', width: this.width ? this.width + 'px' : undefined })} data-rozie-s-d3ac8fdc>
  
  <canvas role="img" aria-label=${this.ariaLabel} data-rozie-ref="canvasEl" data-rozie-s-d3ac8fdc><slot name="fallback"></slot></canvas>
</div>
