...
@customElement('rozie-line')
export default class Line extends SignalWatcher(LitElement) {
  static styles = css`
:host{display:contents}
.rozie-chart[data-rozie-s-4270cd12] {
  position: relative;
  width: 100%;
}
...
private _portalContainers = new Set<HTMLElement>();
  ...
  render() {
    return html`
<div class="rozie-chart" style=${styleMap({ height: this.height + 'px', width: this.width ? this.width + 'px' : undefined })} data-rozie-s-4270cd12>
  
  <canvas role="img" aria-label=${this.ariaLabel} data-rozie-ref="canvasEl" data-rozie-s-4270cd12><slot name="fallback"></slot></canvas>
</div>
...
injectGlobalStyles('rozie-line-ca86a880-global', `
.rozie-chart .rozie-chart-tooltip {
    background: rgba(0, 0, 0, 0.8);
    color: #fff;
    border-radius: 4px;
