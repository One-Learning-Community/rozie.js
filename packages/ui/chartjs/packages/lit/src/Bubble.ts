...
private _portalContainers = new Set<HTMLElement>();
  ...
  render() {
    return html`
<div class="rozie-chart" style=${styleMap({ height: this.height + 'px', width: this.width ? this.width + 'px' : undefined })} data-rozie-s-da10bb9e>
  
  <canvas role="img" aria-label=${this.ariaLabel} data-rozie-ref="canvasEl" data-rozie-s-da10bb9e><slot name="fallback"></slot></canvas>
</div>
