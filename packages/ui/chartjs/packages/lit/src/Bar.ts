...
@customElement('rozie-bar')
export default class Bar extends SignalWatcher(LitElement) {
  static styles = css`
.rozie-chart[data-rozie-s-ed04b5ca] {
  position: relative;
  width: 100%;
}
.rozie-chart[data-rozie-s-ed04b5ca] canvas[data-rozie-s-ed04b5ca] {
  display: block;
  width: 100% !important;
  height: 100% !important;
}
.rozie-chart[data-rozie-s-ed04b5ca] [data-rozie-s-ed04b5ca]:global(.rozie-chart-tooltip) {
...
private _portalContainers = new Set<HTMLElement>();
  ...
  render() {
    return html`
<div class="rozie-chart" style=${styleMap({ height: this.height + 'px', width: this.width ? this.width + 'px' : undefined })} data-rozie-s-ed04b5ca>
  
  <canvas role="img" aria-label=${this.ariaLabel} data-rozie-ref="canvasEl" data-rozie-s-ed04b5ca><slot name="fallback"></slot></canvas>
</div>
