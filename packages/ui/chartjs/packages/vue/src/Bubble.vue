...
const props = withDefaults(
  defineProps<{ data?: Record<string, any>; options?: Record<string, any>; height?: number; width?: number; plugins?: any[]; updateMode?: string; redraw?: boolean; ariaLabel?: string; datasetIdKey?: string; destroyDelay?: number }>(),
  { data: () => ({
  labels: [],
  datasets: []
...
defineExpose({ getChart, updateChart, resizeChart, resetChart, renderChart, stopChart, clearChart, toBase64Image });
</script>
