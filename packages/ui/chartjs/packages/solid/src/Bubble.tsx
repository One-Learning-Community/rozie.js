...
__rozieInjectStyle('Bubble-da10bb9e', `.rozie-chart[data-rozie-s-da10bb9e] {
  position: relative;
  width: 100%;
}
.rozie-chart[data-rozie-s-da10bb9e] canvas[data-rozie-s-da10bb9e] {
  display: block;
  width: 100% !important;
  height: 100% !important;
}
.rozie-chart[data-rozie-s-da10bb9e] [data-rozie-s-da10bb9e]:global(.rozie-chart-tooltip) {
...
export default function Bubble(_props: BubbleProps): JSX.Element {
  ...
  return (
    <>
    <div class={"rozie-chart"} style={{ height: local.height + 'px', width: local.width ? local.width + 'px' : undefined }} data-rozie-s-da10bb9e="">
      
      <canvas ref={(el) => { canvasElRef = el as HTMLElement; }} role="img" aria-label={local.ariaLabel} data-rozie-s-da10bb9e="">{(_props.fallbackSlot ?? _props.slots?.['fallback']?.({}))}</canvas>
    </div>
