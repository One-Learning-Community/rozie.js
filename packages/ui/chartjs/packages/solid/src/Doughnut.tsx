...
__rozieInjectStyle('Doughnut-5b1179de', `.rozie-chart[data-rozie-s-5b1179de] {
  position: relative;
  width: 100%;
}
...
.rozie-chart[data-rozie-s-5b1179de] [data-rozie-s-5b1179de]:global(.rozie-chart-tooltip) {
...
export default function Doughnut(_props: DoughnutProps): JSX.Element {
  ...
  return (
    <>
    <div class={"rozie-chart"} style={{ height: local.height + 'px', width: local.width ? local.width + 'px' : undefined }} data-rozie-s-5b1179de="">
      
      <canvas ref={(el) => { canvasElRef = el as HTMLElement; }} role="img" aria-label={local.ariaLabel} data-rozie-s-5b1179de="">{(_props.fallbackSlot ?? _props.slots?.['fallback']?.({}))}</canvas>
    </div>
