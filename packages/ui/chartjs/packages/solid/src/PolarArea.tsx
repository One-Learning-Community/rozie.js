...
__rozieInjectStyle('PolarArea-52afe0aa', `.rozie-chart[data-rozie-s-52afe0aa] {
  position: relative;
  width: 100%;
}
.rozie-chart[data-rozie-s-52afe0aa] canvas[data-rozie-s-52afe0aa] {
  display: block;
  width: 100% !important;
  height: 100% !important;
}
.rozie-chart[data-rozie-s-52afe0aa] [data-rozie-s-52afe0aa]:global(.rozie-chart-tooltip) {
...
export default function PolarArea(_props: PolarAreaProps): JSX.Element {
  ...
  return (
    <>
    <div class={"rozie-chart"} style={{ height: local.height + 'px', width: local.width ? local.width + 'px' : undefined }} data-rozie-s-52afe0aa="">
      
      <canvas ref={(el) => { canvasElRef = el as HTMLElement; }} role="img" aria-label={local.ariaLabel} data-rozie-s-52afe0aa="">{(_props.fallbackSlot ?? _props.slots?.['fallback']?.({}))}</canvas>
    </div>
