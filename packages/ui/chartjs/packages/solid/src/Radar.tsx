...
__rozieInjectStyle('Radar-6680f000', `.rozie-chart[data-rozie-s-6680f000] {
  position: relative;
  width: 100%;
}
...
.rozie-chart[data-rozie-s-6680f000] [data-rozie-s-6680f000]:global(.rozie-chart-tooltip) {
...
export default function Radar(_props: RadarProps): JSX.Element {
  ...
  return (
    <>
    <div class={"rozie-chart"} style={{ height: local.height + 'px', width: local.width ? local.width + 'px' : undefined }} data-rozie-s-6680f000="">
      
      <canvas ref={(el) => { canvasElRef = el as HTMLElement; }} role="img" aria-label={local.ariaLabel} data-rozie-s-6680f000="">{(_props.fallbackSlot ?? _props.slots?.['fallback']?.({}))}</canvas>
    </div>
