...
`;
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'model-value', 'modelvalue', 'total-pages', 'totalpages', 'total', 'page-size', 'pagesize', 'sibling-count', 'siblingcount', 'boundary-count', 'boundarycount', 'disabled', 'aria-label', 'arialabel']);
