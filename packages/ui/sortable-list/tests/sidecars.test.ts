 ...
 * what commit `4a095fdd` had to clean up for the sibling tiptap family
 * (tiptap-vue, 0.1.1 → 0.2.0). This suite converts that silent re-dirtying
 * into a RED TEST.
 */
...
const COMPONENT = 'SortableList';
const TAG = 'rozie-sortable-list';
...
describe('vue leaf — web-types.json sidecar', () => {
  ...
  // regen: run `pnpm --filter @rozie-ui/sortable-list build` and commit the regenerated
