...
Idiomatic **svelte** `SortableList` — a cross-framework drag-and-drop list compiled from one [Rozie](https://github.com/) source via SortableJS. This package is generated; do not edit `src/` by hand.
