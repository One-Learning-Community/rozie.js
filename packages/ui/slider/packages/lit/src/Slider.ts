...
<div class="${Object.entries({ "rozie-slider": true, 'rozie-slider--vertical': this.orientation === 'vertical', 'rozie-slider--horizontal': this.orientation !== 'vertical', 'rozie-slider--range': this.range, 'rozie-slider--disabled': this.disabled }).filter(([, v]) => v).map(([k]) => k).join(' ')}" style=${rozieStyle(this.fillStyle)} ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-4e6f0be6>
  ...
  </div>` : nothing}${!this.range ? html`<input class="rozie-slider-input" type="range" min=${this.min} max=${this.max} step=${this.step} .value=${this.singleValue()} ?disabled=${!!this.disabled} aria-label=${rozieAttr(this.ariaLabel)} aria-orientation=${rozieAttr(this.orientation === 'vertical' ? 'vertical' : 'horizontal')} aria-valuetext=${rozieAttr(this.formatValue !== null ? this.display(this.singleValue()) : null)} @input=${($event: InputEvent & { currentTarget: HTMLInputElement; target: HTMLInputElement }) => { this.onInputSingle($event); }} @keydown=${($event: KeyboardEvent & { currentTarget: HTMLInputElement; target: HTMLInputElement }) => { this.onKeyDownSingle($event); }} data-rozie-ref="inputEl" data-rozie-s-4e6f0be6 />` : nothing}${this.range ? html`<input class="rozie-slider-input rozie-slider-input--lo" type="range" min=${this.min} max=${this.max} step=${this.step} .value=${this.rangePair()[0]} ?disabled=${!!this.disabled} aria-label=${rozieAttr(this.ariaLabel)} aria-orientation=${rozieAttr(this.orientation === 'vertical' ? 'vertical' : 'horizontal')} aria-valuetext=${rozieAttr(this.formatValue !== null ? this.display(this.rangePair()[0]) : null)} @input=${($event: InputEvent & { currentTarget: HTMLInputElement; target: HTMLInputElement }) => { this.onInputLo($event); }} @keydown=${($event: KeyboardEvent & { currentTarget: HTMLInputElement; target: HTMLInputElement }) => { this.onKeyDownRange('lo', $event); }} data-rozie-ref="inputEl" data-rozie-s-4e6f0be6 />` : nothing}${this.range ? html`<input class="rozie-slider-input rozie-slider-input--hi" type="range" min=${this.min} max=${this.max} step=${this.step} .value=${this.rangePair()[1]} ?disabled=${!!this.disabled} aria-label=${rozieAttr(this.ariaLabel)} aria-orientation=${rozieAttr(this.orientation === 'vertical' ? 'vertical' : 'horizontal')} aria-valuetext=${rozieAttr(this.formatValue !== null ? this.display(this.rangePair()[1]) : null)} @input=${($event: InputEvent & { currentTarget: HTMLInputElement; target: HTMLInputElement }) => { this.onInputHi($event); }} @keydown=${($event: KeyboardEvent & { currentTarget: HTMLInputElement; target: HTMLInputElement }) => { this.onKeyDownRange('hi', $event); }} data-rozie-s-4e6f0be6 />` : nothing}</div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'value', 'range', 'min', 'max', 'step', 'orientation', 'disabled', 'marks', 'aria-label', 'arialabel', 'page-step', 'pagestep', 'format-value', 'formatvalue', 'show-value', 'showvalue']);
