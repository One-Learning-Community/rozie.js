...
interface Props {
   ...
   * @example
   * <Slider bind:value={volume} min={0} max={100} step={1} ariaLabel="Volume" />
   */
  value?: (unknown) | null;
  /**
...
const mark$$slot = $derived(__markProp ?? snippets?.mark);
