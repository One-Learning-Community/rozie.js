 ...
 *   5. ENFORCE validateDocsPropsTable against docs/guide/cropper.md
...
function main() {
  ...
  // (5) ENFORCE docs props-table validation against docs/guide/cropper.md.
  const guideRelPath = 'docs/guide/cropper.md';
  ...
  if (!guideExists) {
    console.log(
      'codegen: docs props-table validation SKIPPED — docs/guide/cropper.md not yet authored ' +
