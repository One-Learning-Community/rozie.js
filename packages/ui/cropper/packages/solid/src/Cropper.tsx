...
export default function Cropper(_props: CropperProps): JSX.Element {
  ...
  const [local, attrs] = splitProps(_merged, ['src', 'data', 'aspectRatio', 'viewMode', 'dragMode', 'disabled', 'guides', 'center', 'background', 'movable', 'rotatable', 'scalable', 'zoomable', 'zoomOnWheel', 'cropBoxMovable', 'cropBoxResizable', 'autoCrop', 'autoCropArea', 'responsive', 'preview', 'options', 'ref', 'onReady', 'onCropstart', 'onCropmove', 'onCropend', 'onCrop', 'onZoom']);
