...
const props = withDefaults(
  defineProps<{
     ...
     * @example
     * <Carousel :slides="['A', 'B', 'C']" v-model:selectedIndex="idx" />
     */
    slides?: any[];
    /**
 ...
 * @example
 * <Carousel :slides="items" v-model:selectedIndex="idx" />
 */
...
const initialOptions = () => {
  ...
  opts = {
    ...
    slides: [].length > 0 ? [...viewportElRef.value!.querySelectorAll('.rozie-embla__slide'), ...[]] : '.rozie-embla__slide',
    loop: props.loop,
    align: props.align,
    axis: props.axis,
