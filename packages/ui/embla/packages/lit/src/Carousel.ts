...
`;
  ...
  opts = {
    ...
    slides: this._slotDefaultAssigned.value.length > 0 ? [...this._refViewportEl.querySelectorAll('.rozie-embla__slide'), ...this._slotDefaultAssigned.value] : '.rozie-embla__slide',
    loop: this.loop,
    align: this.align,
    axis: this.axis,
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'slides', 'loop', 'align', 'axis', 'slides-to-scroll', 'slidestoscroll', 'drag-free', 'dragfree', 'draggable', 'contain-scroll', 'containscroll', 'start-index', 'startindex', 'skip-snaps', 'skipsnaps', 'duration', 'direction', 'autoplay', 'autoplay-delay', 'autoplaydelay', 'dots', 'arrows', 'thumbnails', 'plugins', 'options', 'selected-index', 'selectedindex']);
