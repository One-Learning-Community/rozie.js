...
```bash
npm i @rozie-ui/embla-lit
```

Peer dependencies: the `embla-carousel` (`^8.6`) + `embla-carousel-autoplay` (`^8.6`) engine packages + `lit + @lit-labs/preact-signals + @preact/signals-core`. Install them alongside this package.
