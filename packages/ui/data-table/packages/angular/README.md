...
```ts
import '@rozie-ui/data-table-angular/themes/base.css';
import '@rozie-ui/data-table-angular/themes/shadcn.css';    // or material.css, bootstrap.css
```
