...
export interface DataTableProps {
  ...
  children?: ReactNode;
  renderGroupBar?: (params: { grouping: unknown; groupableColumns: unknown; applyGrouping: unknown; clearGrouping: unknown }) => ReactNode;
  renderSelectAll?: (params: { checked: unknown; indeterminate: unknown; toggle: unknown }) => ReactNode;
  renderColHeader?: (params: { columnId: unknown; column: unknown; label: unknown }) => ReactNode;
  renderColHeader?: (params: { columnId: unknown; column: unknown; label: unknown }) => ReactNode;
  renderFilter?: (params: { columnId: unknown; value: unknown; uniqueValues: unknown; minMax: unknown; setFilter: unknown }) => ReactNode;
