...
export interface DataTableProps {
  ...
  slots?: { [key: `colHeader-${string}`]: ((params: { columnId: any; column: any; label: any }) => ReactNode) | undefined; [key: `cell-${string}`]: ((params: { columnId: any; column: any; row: any; value: any }) => ReactNode) | undefined; [key: string]: ((...args: any[]) => ReactNode) | undefined; };
}
