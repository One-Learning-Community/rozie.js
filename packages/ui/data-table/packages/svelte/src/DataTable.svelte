...
interface Props {
  ...
  snippets?: { [key: `colHeader-${string}`]: Snippet<[{ columnId: any; column: any; label: any }]>; [key: `cell-${string}`]: Snippet<[{ columnId: any; column: any; row: any; value: any }]>; } & Record<string, any>;
