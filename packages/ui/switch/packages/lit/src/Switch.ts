...
`;
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'model-value', 'modelvalue', 'disabled', 'readonly', 'aria-label', 'arialabel']);
