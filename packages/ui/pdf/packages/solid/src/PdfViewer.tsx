...
export default function PdfViewer(_props: PdfViewerProps): JSX.Element {
  ...
  const [local, attrs] = splitProps(_merged, ['src', 'page', 'scale', 'rotation', 'workerSrc', 'standardFontDataUrl', 'renderAllPages', 'textLayer', 'password', 'query', 'autoFit', 'options', 'ref', 'onPagerendered', 'onError', 'onPagesrendered', 'onPasswordrequest', 'onProgress', 'onLoad', 'onPagechange', 'onFindresult']);
