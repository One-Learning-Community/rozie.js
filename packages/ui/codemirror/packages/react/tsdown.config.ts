...
export default defineConfig({
  ...
  // The generated React component does a side-effect `import './CodeMirror.css'`
  ...
  // EXTERNAL so tsdown leaves the `./CodeMirror.css` specifier verbatim in the
  ...
  copy: [{ from: 'src/CodeMirror.css', to: 'dist', flatten: true }],
});
