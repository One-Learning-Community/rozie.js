...
```svelte
import '@rozie-ui/date-picker-svelte/themes/shadcn.css';    // or material.css, bootstrap.css, base.css
```
...
| Slot | Params |
| --- | --- |
| header | label, prev, next, disabled, openMonths, openYears, closeDrill, viewMode |
