...
export default defineConfig({
  ...
  dts: true,
  clean: true,
  // The generated barrel re-exports both the named component (`DatePicker`) and its
  ...
  // The generated component does a side-effect `import './DatePicker.css'`; mark it
  // external and copy the file into dist so the relative specifier resolves at
  // the consumer's bundler.
  copy: [{ from: 'src/DatePicker.css', to: 'dist', flatten: true }],
});
