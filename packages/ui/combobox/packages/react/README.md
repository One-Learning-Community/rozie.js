...
```bash
npm i @rozie-ui/combobox-react @rozie-ui/popover-react @floating-ui/dom
```
...
```tsx
import '@rozie-ui/combobox-react/themes/shadcn.css';    // or material.css, bootstrap.css, base.css
```
