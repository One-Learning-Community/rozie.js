...
```bash
npm i @rozie-ui/combobox-vue @rozie-ui/popover-vue @floating-ui/dom
```
...
```ts
import '@rozie-ui/combobox-vue/themes/shadcn.css';    // or material.css, bootstrap.css, base.css
```
