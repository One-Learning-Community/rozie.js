...
export default function Otp(_props: OtpProps): JSX.Element {
  ...
  return (
    <>
    <div classList={{ 'rozie-otp--disabled': local.disabled }} ref={(el) => { rootRef = el as HTMLElement; }} role="group" aria-label={local.ariaLabel} {...attrs} class={"rozie-otp" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-8267d52a="">
