...
export default function Otp(_props: OtpProps): JSX.Element {
  ...
  return (
    <>
    <div ref={(el) => { rootRef = el as HTMLElement; }} role="group" aria-label={local.ariaLabel} {...attrs} class={"rozie-otp" + " " + rozieClass({ 'rozie-otp--disabled': local.disabled }) + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-8267d52a="">
