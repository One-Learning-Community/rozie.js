...
`;
   ...
   */
  @property({ type: String, reflect: true }) output?: string;
  /**
   ...
   */
  @property({ type: String, reflect: true }) input?: string;
  /**
   ...
   */
  @property({ type: Object }) multiple?: unknown;
  /**
   ...
   */
  @property({ type: String, reflect: true }) position?: string;
