...
`;
   ...
   * @example
   * <rozie-node-type type="source"><rozie-port output="num" type="number"></rozie-port></rozie-node-type>
   */
   ...
   * @example
   * <rozie-node-type type="task" .width=${240}><rozie-port output="out"></rozie-port></rozie-node-type>
   */
  @property({ type: Number, reflect: true }) width: number | null = null;
  /**
   ...
   * @example
   * <rozie-node-type type="task" .height=${120}><rozie-port output="out"></rozie-port></rozie-node-type>
   */
  @property({ type: Number, reflect: true }) height: number | null = null;
  /**
