...
<div class="rozie-node-type-children" style="display:none" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-372f9492><slot></slot></div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'type', 'resizable', 'min-width', 'minwidth', 'min-height', 'minheight', 'max-width', 'maxwidth', 'max-height', 'maxheight']);
