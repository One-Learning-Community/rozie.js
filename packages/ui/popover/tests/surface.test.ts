/**
 * surface.test.ts — the Popover.rozie surface gate as a vitest test (so it runs
 * under `turbo run test`, not just scripts/compile-popover-check.mjs).
 *
...
const SRC = resolve(HERE, '..', 'src', 'Popover.rozie');
...
describe('Popover.rozie surface gate', () => {
