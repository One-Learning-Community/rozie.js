...
Idiomatic **react** `Flatpickr` — a cross-framework date picker compiled from one [Rozie](https://github.com/) source wrapping [flatpickr](https://flatpickr.js.org/). This package is generated; do not edit `src/` by hand.
