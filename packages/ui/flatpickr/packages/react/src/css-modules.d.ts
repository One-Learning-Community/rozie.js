/**
 * Ambient module declaration so the emitted `Flatpickr.tsx` can
 * `import './Flatpickr.css'` (a side-effect import) without tripping TS2307
 * under `tsc --noEmit`.
 *
 ...
 * `import './Flatpickr.css'`. This leaf's typecheck gate hands the generated
 ...
 * tests/react-typecheck/css-modules.d.ts and the sortable-list leaf.
 */
declare module '*.css';
