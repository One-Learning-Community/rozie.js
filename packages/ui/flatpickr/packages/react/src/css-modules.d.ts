/**
 * Ambient module declarations so the emitted `Flatpickr.tsx` can
 * `import styles from './Flatpickr.module.css'` (and bare `.css` side-effect
 ...
 * Mirrors tests/react-typecheck/css-modules.d.ts and the sortable-list leaf.
 */
