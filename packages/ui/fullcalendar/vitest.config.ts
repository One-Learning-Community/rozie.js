// Vitest config for @rozie-ui/fullcalendar.
//
...
// re-asserts the FullCalendar.rozie compile()/lowerToIR surface, so a drift in
// the 13-prop / 11-emit / 10-slot / 16-expose surface or a new compile() error
// diagnostic fails the test gate.
//
