# @rozie-ui/lexical-angular

Idiomatic **angular** `LexicalEditor` — Cross-framework rich-text editor wrapping Meta’s Lexical — one Rozie source, idiomatic React / Vue / Svelte / Angular / Solid packages. Compiled from one [Rozie](https://github.com/One-Learning-Community/rozie.js) source. This package is generated; do not edit `src/` by hand.
...
```bash
npm i @rozie-ui/lexical-angular
```

Peer dependencies: `lexical` + `@angular/core + @angular/common`.
