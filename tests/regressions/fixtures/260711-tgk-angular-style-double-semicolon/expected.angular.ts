...
@Component({
  selector: 'rozie-style-double-semicolon',
  standalone: true,
  imports: [NgStyle],
  template: `
  ...
  `,
  styles: [`
    :host(rozie-style-double-semicolon) { display: contents; }
  `],
})
export class StyleDoubleSemicolon {
  colId = input<string>('a');
  pad = signal('padding-left:8px');
...
export default StyleDoubleSemicolon;
