...
@Component({
  selector: 'rozie-slot-conditional-default-slot-rif',
  standalone: true,
  ...
  `,
  styles: [`
    :host(rozie-slot-conditional-default-slot-rif) { display: contents; }
  `],
})
export class SlotConditionalDefaultSlotRIf {
  ...
  static ngTemplateContextGuard(
    _dir: SlotConditionalDefaultSlotRIf,
    _ctx: unknown,
  ): _ctx is DefaultCtx {
    return true;
  }
...
export default SlotConditionalDefaultSlotRIf;
