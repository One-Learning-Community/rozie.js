...
export default function OnMountArrowCleanup(_props: OnMountArrowCleanupProps): JSX.Element {
  ...
  return (
    ...
    <>
    <div {...attrs} class={"ticker" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...attrs} data-rozie-s-722b58d1="">{ticks()}</div>
    </>
    </>
  );
}
