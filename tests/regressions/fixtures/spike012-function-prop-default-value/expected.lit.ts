...
`;
  ...
  render() {
    return html`
<div class="r" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-8a79dce7><input @input=${this._tw0} data-rozie-s-8a79dce7 /></div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'on-pick', 'onpick']);
