...
@customElement('rozie-slot-conditional-slot-rif-with-fallback')
export default class SlotConditionalSlotRIfWithFallback extends SignalWatcher(LitElement) {
  static styles = css`
...
<div class="r" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-44d0c1d8>${this.show ? html`<slot><span data-rozie-s-44d0c1d8>fallback</span></slot>` : nothing}</div>
`;
  }
