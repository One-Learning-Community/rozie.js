...
@Component({
  selector: 'rozie-slot-conditional-slot-rif-with-fallback',
  standalone: true,
  ...
  `,
  styles: [`
    :host(rozie-slot-conditional-slot-rif-with-fallback) { display: contents; }
  `],
})
export class SlotConditionalSlotRIfWithFallback {
  ...
  static ngTemplateContextGuard(
    _dir: SlotConditionalSlotRIfWithFallback,
    _ctx: unknown,
  ): _ctx is DefaultCtx {
    return true;
  }
...
export default SlotConditionalSlotRIfWithFallback;
