...
`;
  ...
  render() {
    return html`
  <div ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-6d99ef35>
    <span style=${styleMap({ color: 'red' })} data-rozie-s-6d99ef35>object literal</span>
    <span style=${rozieStyle(this.s)} data-rozie-s-6d99ef35>string via prop</span>
    <span style=${rozieStyle(this.obj)} data-rozie-s-6d99ef35>object via prop</span>
  </div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 's', 'obj']);
