...
@Component({
  selector: 'rozie-style-norm-shapes',
  standalone: true,
  template: `

      <div #rozieSpread_0 #rozieListenersTarget_1>
        <span [style]="{ color: 'red' }">object literal</span>
        <span [style]="s()">string via prop</span>
        <span [style]="obj()">object via prop</span>
      </div>
...
export default StyleNormShapes;
