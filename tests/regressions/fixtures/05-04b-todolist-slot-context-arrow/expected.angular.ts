import { Component, ContentChild, ElementRef, Renderer2, TemplateRef, ViewEncapsulation, afterRenderEffect, computed, inject, input, model, viewChild } from '@angular/core';
