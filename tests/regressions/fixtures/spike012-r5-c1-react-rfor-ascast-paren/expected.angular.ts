...
@Component({
  selector: 'rozie-rfor-as-cast-paren',
  standalone: true,
  template: `

    <div class="r" #rozieSpread_0 #rozieListenersTarget_1><ul>@for (it of $any(items()); track it) {
    <li>{{ rozieDisplay(it) }}</li>
    }</ul></div>
...
export default RforAsCastParen;
