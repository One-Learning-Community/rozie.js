...
export default function SlotConditionalSlotRIfElementRElse(_props: SlotConditionalSlotRIfElementRElseProps): JSX.Element {
  ...
  return (
    ...
    <div {...attrs} class={"r" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-ae404d71="">{<Show when={local.show} fallback={<p data-rozie-s-ae404d71="">nothing</p>}>{resolved()}</Show>}</div>
    </>
  );
}
