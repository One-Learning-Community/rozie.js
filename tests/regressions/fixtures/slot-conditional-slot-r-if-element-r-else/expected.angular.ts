...
@Component({
  selector: 'rozie-slot-conditional-slot-rif-element-relse',
  standalone: true,
  ...
  `,
  styles: [`
    :host(rozie-slot-conditional-slot-rif-element-relse) { display: contents; }
  `],
})
export class SlotConditionalSlotRIfElementRElse {
  ...
  static ngTemplateContextGuard(
    _dir: SlotConditionalSlotRIfElementRElse,
    _ctx: unknown,
  ): _ctx is DefaultCtx {
    return true;
  }
...
export default SlotConditionalSlotRIfElementRElse;
