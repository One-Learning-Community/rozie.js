...
@customElement('rozie-nested-fn-decl-expose-shadow')
export default class NestedFnDeclExposeShadow extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="n" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-c9777fd9>${this._n.value}</div>
`;
  }
