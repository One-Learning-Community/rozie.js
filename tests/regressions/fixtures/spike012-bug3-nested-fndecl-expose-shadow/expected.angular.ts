...
@Component({
  selector: 'rozie-nested-fn-decl-expose-shadow',
  standalone: true,
  template: `
  ...
  `,
  styles: [`
    :host(rozie-nested-fn-decl-expose-shadow) { display: contents; }
  `],
})
export class NestedFnDeclExposeShadow {
  n = signal(0);
...
export default NestedFnDeclExposeShadow;
