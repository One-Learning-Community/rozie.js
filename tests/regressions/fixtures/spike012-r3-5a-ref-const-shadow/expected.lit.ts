...
`;
  ...
  firstUpdated(): void {
    this._n.value = (this._refBox as HTMLElement).childElementCount + this.box;
  }
  ...
  render() {
    return html`
<div class="r" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-477c96a9><div data-rozie-ref="box" data-rozie-s-477c96a9>x</div></div>
`;
  }
