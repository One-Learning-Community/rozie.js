...
@customElement('rozie-slot-conditional-named-slot-rif')
export default class SlotConditionalNamedSlotRIf extends SignalWatcher(LitElement) {
  static styles = css`
...
<div class="r" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-91cab247>${this.show ? html`<slot name="header"></slot>` : nothing}</div>
`;
  }
