...
@Component({
  selector: 'rozie-slot-conditional-named-slot-rif',
  standalone: true,
  ...
  `,
  styles: [`
    :host(rozie-slot-conditional-named-slot-rif) { display: contents; }
  `],
})
export class SlotConditionalNamedSlotRIf {
  ...
  static ngTemplateContextGuard(
    _dir: SlotConditionalNamedSlotRIf,
    _ctx: unknown,
  ): _ctx is HeaderCtx {
    return true;
  }
...
export default SlotConditionalNamedSlotRIf;
