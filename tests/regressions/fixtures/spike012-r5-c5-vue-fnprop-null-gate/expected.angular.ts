...
@Component({
  selector: 'rozie-fn-prop-null-gate',
  standalone: true,
  template: `

    <div class="fpg" #rozieSpread_0 #rozieListenersTarget_1>
      <button class="save" (click)="(onSave())($event)">save</button>
      <button class="cancel" (click)="onCancel() && onCancel()()">cancel</button>
      <span class="n">{{ n() }}</span>
    </div>
