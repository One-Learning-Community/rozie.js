...
<div {...__rozieAttrs} class={["partial-inline-host", (__rozieAttrs)?.class]} use:applyListeners={__rozieAttrs} data-rozie-s-3f0d2452><span class="echo" data-rozie-s-3f0d2452>{rozieDisplay(ariaSortK(1))}</span><span class="echo" data-rozie-s-3f0d2452>{rozieDisplay(sortIndicatorK(1))}</span></div>
