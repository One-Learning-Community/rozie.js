...
@customElement('rozie-partial-inline-host-c')
export default class PartialInlineHostC extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-d770543a>
  <span class="echo" data-rozie-s-d770543a>${rozieDisplay(this.usedName)}</span>
</div>
`;
  }
