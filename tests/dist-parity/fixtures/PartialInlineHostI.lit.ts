...
@customElement('rozie-partial-inline-host-i')
export default class PartialInlineHostI extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-58c4107a>
  <span class="echo" data-rozie-s-58c4107a>${rozieDisplay(this.rangeTransitionI)}</span>
  <span class="echo" data-rozie-s-58c4107a>${rozieDisplay(this.afterDeclI(1))}</span>
  <span class="echo" data-rozie-s-58c4107a>${rozieDisplay(this.fillDragUpI)}</span>
</div>
`;
  }
