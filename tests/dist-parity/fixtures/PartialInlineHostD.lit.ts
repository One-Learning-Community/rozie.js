...
@customElement('rozie-partial-inline-host-d')
export default class PartialInlineHostD extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-dd6eac9a>
  <span class="echo" data-rozie-s-dd6eac9a>${rozieDisplay(this.outer)}</span>
</div>
`;
  }
