...
export default function InlineEquivHostH(_props: InlineEquivHostHProps): JSX.Element {
  ...
  return (
    <>
    <div {...attrs} class={"partial-inline-host" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-a125a3da="">
      <span class={"echo"} data-rozie-s-a125a3da="">{rozieDisplay(editTransitionH)}</span>
      <span class={"echo"} data-rozie-s-a125a3da="">{rozieDisplay(editorBindingsH(1))}</span>
    </div>
    </>
  );
}
