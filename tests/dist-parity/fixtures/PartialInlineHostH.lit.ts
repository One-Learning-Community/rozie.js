...
@customElement('rozie-partial-inline-host-h')
export default class PartialInlineHostH extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-3844649a>
  <span class="echo" data-rozie-s-3844649a>${rozieDisplay(this.editTransitionH)}</span>
  <span class="echo" data-rozie-s-3844649a>${rozieDisplay(this.editorBindingsH(1))}</span>
</div>
`;
  }
