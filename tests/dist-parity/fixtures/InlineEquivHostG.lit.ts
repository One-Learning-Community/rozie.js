...
@customElement('rozie-inline-equiv-host-g')
export default class InlineEquivHostG extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-72aa62a2>
  <span class="echo" data-rozie-s-72aa62a2>${rozieDisplay(this.selectAllBoxG)}</span>
  <span class="echo" data-rozie-s-72aa62a2>${rozieDisplay(this.afterDeclG(1))}</span>
  <span class="echo" data-rozie-s-72aa62a2>${rozieDisplay(this.rangeTransitionG)}</span>
  <span class="echo" data-rozie-s-72aa62a2>${rozieDisplay(this.beforeDeclG(1))}</span>
  <span class="echo" data-rozie-s-72aa62a2>${rozieDisplay(this.fillDragUpG)}</span>
</div>
`;
  }
