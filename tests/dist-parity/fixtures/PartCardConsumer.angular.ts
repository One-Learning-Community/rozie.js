...
@Component({
  selector: 'rozie-part-card-consumer',
  standalone: true,
  imports: [PartCard],
  template: `

    <div class="part-card-consumer" #rozieSpread_0 #rozieListenersTarget_1>
      <rozie-part-card [title]="'Hello'"><ng-template #defaultSlot>
        Cross-shadow styled body content.
      </ng-template></rozie-part-card>
    </div>
