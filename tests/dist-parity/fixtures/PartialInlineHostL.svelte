...
<div {...__rozieAttrs} class={["partial-inline-host", (__rozieAttrs)?.class]} use:applyListeners={__rozieAttrs} data-rozie-s-e05b5f1a><span class="echo" data-rozie-s-e05b5f1a>{rozieDisplay(verbL(1))}</span><span class="echo" data-rozie-s-e05b5f1a>{rozieDisplay(verb2L(1))}</span></div>
