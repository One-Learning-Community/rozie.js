...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-5163a222>
  <span class="echo" data-rozie-s-5163a222>${rozieDisplay(this.usedName)}</span>
</div>
`;
  }
