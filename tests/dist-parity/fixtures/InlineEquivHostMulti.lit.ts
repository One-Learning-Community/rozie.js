...
@customElement('rozie-inline-equiv-host-multi')
export default class InlineEquivHostMulti extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-f6996e0e>
  <span class="echo" data-rozie-s-f6996e0e>${rozieDisplay(this.editTransitionM)}</span>
  <span class="echo" data-rozie-s-f6996e0e>${rozieDisplay(this.hostTailM(1))}</span>
  <span class="echo" data-rozie-s-f6996e0e>${rozieDisplay(this.columnChromeM(1))}</span>
  <span class="echo" data-rozie-s-f6996e0e>${rozieDisplay(this.outerM)}</span>
</div>
`;
  }
