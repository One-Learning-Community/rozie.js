...
@customElement('rozie-partial-inline-host-multi')
export default class PartialInlineHostMulti extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-66a0496a>
  <span class="echo" data-rozie-s-66a0496a>${rozieDisplay(this.editTransitionM)}</span>
  <span class="echo" data-rozie-s-66a0496a>${rozieDisplay(this.hostTailM(1))}</span>
  <span class="echo" data-rozie-s-66a0496a>${rozieDisplay(this.columnChromeM(1))}</span>
  <span class="echo" data-rozie-s-66a0496a>${rozieDisplay(this.outerM)}</span>
</div>
`;
  }
