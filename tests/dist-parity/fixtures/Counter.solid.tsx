...
export default function Counter(_props: CounterProps): JSX.Element {
  ...
  return (
    <>
    <div {...attrs} class={"counter" + " " + rozieClass({ hovering: hovering() }) + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...mergeListeners({ onMouseEnter: ($event: MouseEvent & { currentTarget: HTMLDivElement; target: Element }) => { setHovering(true); }, onMouseLeave: ($event: MouseEvent & { currentTarget: HTMLDivElement; target: Element }) => { setHovering(false); } }, attrs)} data-rozie-s-c72e01d0="">
