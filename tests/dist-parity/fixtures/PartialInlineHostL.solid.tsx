...
export default function PartialInlineHostL(_props: PartialInlineHostLProps): JSX.Element {
  ...
  v: 1
    ...
    <>
    <div {...attrs} class={"partial-inline-host" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-e05b5f1a="">
      <span class={"echo"} data-rozie-s-e05b5f1a="">{rozieDisplay(verbL(1))}</span>
      <span class={"echo"} data-rozie-s-e05b5f1a="">{rozieDisplay(verb2L(1))}</span>
    </div>
    </>
