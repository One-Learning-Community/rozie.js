...
const usedName = $derived(clamp(double(base)));
</script>

<div {...__rozieAttrs} class={["partial-inline-host", (__rozieAttrs)?.class]} use:applyListeners={__rozieAttrs} data-rozie-s-d770543a><span class="echo" data-rozie-s-d770543a>{rozieDisplay(usedName)}</span></div>
