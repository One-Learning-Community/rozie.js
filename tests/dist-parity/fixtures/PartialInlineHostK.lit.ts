...
@customElement('rozie-partial-inline-host-k')
export default class PartialInlineHostK extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-8263a79a>
  <span class="echo" data-rozie-s-8263a79a>${rozieDisplay(this.ariaSortK(1))}</span>
  <span class="echo" data-rozie-s-8263a79a>${rozieDisplay(this.sortIndicatorK(1))}</span>
</div>
`;
  }
