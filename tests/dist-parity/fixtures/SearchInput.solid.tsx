...
export default function SearchInput(_props: SearchInputProps): JSX.Element {
  ...
  return (
    ...
    <>
    <div {...attrs} class={"search-input" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...attrs} data-rozie-s-8bbc4a60="">
