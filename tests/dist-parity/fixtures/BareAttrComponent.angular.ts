...
@Component({
  selector: 'rozie-bare-attr-component',
  standalone: true,
  imports: [BareAttrChild],
  template: `

    <div class="bare-attr-component" #rozieSpread_0 #rozieListenersTarget_1>
      <rozie-bare-attr-child [combobox]="true"></rozie-bare-attr-child>
      <div hidden=""></div>
    </div>
