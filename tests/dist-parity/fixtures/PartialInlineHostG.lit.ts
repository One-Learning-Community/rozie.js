...
@customElement('rozie-partial-inline-host-g')
export default class PartialInlineHostG extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-298827ca>
  <span class="echo" data-rozie-s-298827ca>${rozieDisplay(this.selectAllBoxG)}</span>
  <span class="echo" data-rozie-s-298827ca>${rozieDisplay(this.afterDeclG(1))}</span>
  <span class="echo" data-rozie-s-298827ca>${rozieDisplay(this.rangeTransitionG)}</span>
  <span class="echo" data-rozie-s-298827ca>${rozieDisplay(this.beforeDeclG(1))}</span>
  <span class="echo" data-rozie-s-298827ca>${rozieDisplay(this.fillDragUpG)}</span>
</div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'base']);
