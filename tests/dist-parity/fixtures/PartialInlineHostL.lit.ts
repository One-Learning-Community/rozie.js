...
private __rozieCtxProvider_themeL = new ContextProvider(this, { context: __rozieCtx_themeL, initialValue: {
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-e05b5f1a>
  <span class="echo" data-rozie-s-e05b5f1a>${rozieDisplay(this.verbL(1))}</span>
  <span class="echo" data-rozie-s-e05b5f1a>${rozieDisplay(this.verb2L(1))}</span>
</div>
`;
  }
