...
`;
  ...
  get canIncrement() { return rozieMemo(this, 'canIncrement', [this.value, this.step, this.max], () => (this.value + this.step <= this.max)); }

  get canDecrement() { return rozieMemo(this, 'canDecrement', [this.value, this.step, this.min], () => (this.value - this.step >= this.min)); }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'value', 'step', 'min', 'max']);
