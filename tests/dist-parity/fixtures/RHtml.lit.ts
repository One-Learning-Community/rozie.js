...
`;
  ...
  @property({ type: String, reflect: true }) content: string = '<strong>safe</strong>';
  ...
  render() {
    return html`
<div class="rhtml" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-09a5f2a6>${unsafeHTML(this.content)}</div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'content']);
