...
export default class InlineEquivHostD extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-bf28abea>
  <span class="echo" data-rozie-s-bf28abea>${rozieDisplay(this.outer)}</span>
</div>
`;
  }
