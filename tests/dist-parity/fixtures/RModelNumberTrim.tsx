...
export default function RModelNumberTrim(props: RModelNumberTrimProps): JSX.Element {
  ...
  return (
    ...
    <div className={styles["rmodel-number-trim"]} data-rozie-s-dfdb7742="">
      <input type="text" placeholder="Enter a quantity" value={quantity} onChange={e => setQuantity((__v => { const __n = parseFloat(__v); return isNaN(__n) ? __v : __n; })(e.target.value.trim()))} data-rozie-s-dfdb7742="" />
