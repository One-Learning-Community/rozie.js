...
<div {...__rozieAttrs} class={["partial-inline-host", (__rozieAttrs)?.class]} use:applyListeners={__rozieAttrs} data-rozie-s-66a0496a><span class="echo" data-rozie-s-66a0496a>{rozieDisplay(editTransitionM)}</span><span class="echo" data-rozie-s-66a0496a>{rozieDisplay(hostTailM(1))}</span><span class="echo" data-rozie-s-66a0496a>{rozieDisplay(columnChromeM(1))}</span><span class="echo" data-rozie-s-66a0496a>{rozieDisplay(outerM)}</span></div>
