import { Component, ElementRef, Renderer2, ViewEncapsulation, afterRenderEffect, computed, inject, input, model, signal, viewChild } from '@angular/core';
