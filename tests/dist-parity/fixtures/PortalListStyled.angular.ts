...
@Component({
  selector: 'rozie-portal-list-styled',
  standalone: true,
  ...
  `,
    ...
    // engine-created DOM.
    `
    :host ::ng-deep [data-rozie-portal-item="18e5aac6"] ul {
      list-style: none;
      margin: 0;
      padding: 0;
    ...
    :host ::ng-deep [data-rozie-portal-item="18e5aac6"] li {
      padding: 0.5rem 0.75rem;
    }
    :host ::ng-deep [data-rozie-portal-item="18e5aac6"] li + li {
      border-top: 1px solid rgba(0, 0, 0, 0.06);
    }
    :host ::ng-deep [data-rozie-portal-item="18e5aac6"] div {
      display: flex;
      align-items: center;
      gap: 0.5rem;
    }
