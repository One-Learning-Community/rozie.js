...
@customElement('rozie-bare-attr-child')
export default class BareAttrChild extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="bare-attr-child" data-combobox=${this.combobox} ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-f0cdfe8a>
...
`;
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'combobox']);
