...
@customElement('rozie-inline-equiv-host-m')
export default class InlineEquivHostM extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-f3df026a>
  <span class="echo" data-rozie-s-f3df026a>${rozieDisplay(this.gridKeydownHandlersM(1, 2))}</span>
  <span class="echo" data-rozie-s-f3df026a>${rozieDisplay(this.refreshRowModelM)}</span>
</div>
`;
  }
