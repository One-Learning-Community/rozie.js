...
@customElement('rozie-partial-inline-host')
export default class PartialInlineHost extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-28f2dfac>
  <span class="echo" data-rozie-s-28f2dfac>${rozieDisplay(this.usedName)}</span>
</div>
`;
  }
