...
<div {...__rozieAttrs} class={["partial-inline-host", (__rozieAttrs)?.class]} use:applyListeners={__rozieAttrs} data-rozie-s-f3df026a><span class="echo" data-rozie-s-f3df026a>{rozieDisplay(gridKeydownHandlersM(1, 2))}</span><span class="echo" data-rozie-s-f3df026a>{rozieDisplay(refreshRowModelM)}</span></div>
