...
`;
  ...
  render() {
    return html`
<div class="prop-docs" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-727424de>
  <span class="label" data-rozie-s-727424de>${this.label}</span>
  <span class="count" data-rozie-s-727424de>${this.count}</span>
</div>
`;
  }
  ...
  private get $attrs(): Record<string, string> {
    const __skip = new Set<string>(['data-rozie-ref', 'label', 'count']);
