...
@customElement('rozie-inline-equiv-host-k')
export default class InlineEquivHostK extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-3f0d2452>
  <span class="echo" data-rozie-s-3f0d2452>${rozieDisplay(this.ariaSortK(1))}</span>
  <span class="echo" data-rozie-s-3f0d2452>${rozieDisplay(this.sortIndicatorK(1))}</span>
</div>
`;
  }
