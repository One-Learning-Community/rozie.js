import { Component, ElementRef, Renderer2, ViewEncapsulation, afterRenderEffect, inject, input, viewChild } from '@angular/core';

@Component({
  selector: 'rozie-themed-button-manual',
  standalone: true,
  template: `
...
export class ThemedButtonManual {
