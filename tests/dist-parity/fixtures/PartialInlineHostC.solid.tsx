...
export default function PartialInlineHostC(_props: PartialInlineHostCProps): JSX.Element {
  ...
  return (
    <>
    <div {...attrs} class={"partial-inline-host" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-d770543a="">
      <span class={"echo"} data-rozie-s-d770543a="">{rozieDisplay(usedName())}</span>
    </div>
    </>
  );
}
