...
@customElement('rozie-inline-equiv-host-e')
export default class InlineEquivHostE extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-625a89aa>
  <span class="echo" data-rozie-s-625a89aa>${rozieDisplay(this.usedNameE(1))}</span>
  <span class="echo" data-rozie-s-625a89aa>${rozieDisplay(this.hostTailE(1))}</span>
</div>
`;
  }
