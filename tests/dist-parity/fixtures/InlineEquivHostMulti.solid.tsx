...
export default function InlineEquivHostMulti(_props: InlineEquivHostMultiProps): JSX.Element {
  ...
  return (
    <>
    <div {...attrs} class={"partial-inline-host" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-f6996e0e="">
      <span class={"echo"} data-rozie-s-f6996e0e="">{rozieDisplay(editTransitionM)}</span>
      <span class={"echo"} data-rozie-s-f6996e0e="">{rozieDisplay(hostTailM(1))}</span>
      <span class={"echo"} data-rozie-s-f6996e0e="">{rozieDisplay(columnChromeM(1))}</span>
      <span class={"echo"} data-rozie-s-f6996e0e="">{rozieDisplay(outerM())}</span>
    </div>
    </>
  );
}
