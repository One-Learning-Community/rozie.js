...
@customElement('rozie-partial-inline-host-m')
export default class PartialInlineHostM extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-5d3a593a>
  <span class="echo" data-rozie-s-5d3a593a>${rozieDisplay(this.gridKeydownHandlersM(1, 2))}</span>
  <span class="echo" data-rozie-s-5d3a593a>${rozieDisplay(this.refreshRowModelM)}</span>
</div>
`;
  }
