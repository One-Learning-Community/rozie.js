...
@customElement('rozie-partial-inline-host-e')
export default class PartialInlineHostE extends SignalWatcher(LitElement) {
  static styles = css`
...
`;
  ...
  render() {
    return html`
<div class="partial-inline-host" ${rozieSpread(this.$attrs)} ${rozieListeners(this.$listeners)} data-rozie-s-7214c3ba>
  <span class="echo" data-rozie-s-7214c3ba>${rozieDisplay(this.usedNameE(1))}</span>
  <span class="echo" data-rozie-s-7214c3ba>${rozieDisplay(this.hostTailE(1))}</span>
</div>
`;
  }
