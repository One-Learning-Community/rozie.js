...
@Component({
  selector: 'rozie-inline-equiv-host-l',
  standalone: true,
  template: `

    <div class="partial-inline-host" #rozieSpread_0 #rozieListenersTarget_1>
      <span class="echo">{{ rozieDisplay(verbL(1)) }}</span>
      <span class="echo">{{ rozieDisplay(verb2L(1)) }}</span>
    </div>

  `,
  styles: [`
    :host(rozie-inline-equiv-host-l) { display: contents; }
  `],
  providers: [
    {
