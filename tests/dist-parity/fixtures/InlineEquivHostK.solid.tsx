...
export default function InlineEquivHostK(_props: InlineEquivHostKProps): JSX.Element {
  ...
  return (
    <>
    <div {...attrs} class={"partial-inline-host" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} data-rozie-s-3f0d2452="">
      <span class={"echo"} data-rozie-s-3f0d2452="">{rozieDisplay(ariaSortK(1))}</span>
      <span class={"echo"} data-rozie-s-3f0d2452="">{rozieDisplay(sortIndicatorK(1))}</span>
    </div>
    </>
  );
}
