...
export default function ThemedButtonListenersManual(_props: ThemedButtonListenersManualProps): JSX.Element {
  const props: ThemedButtonListenersManualProps & { label: string; variant: string } = {
    ..._props,
  ...
  return (
    <>
    <button style={{ '--btn-bg': '#3b82f6', '--btn-fg': '#ffffff' }} {...attrs} className={clsx(clsx(styles.btn, props.variant), (attrs.className as string | undefined))} {...attrs} data-rozie-s-97e125bc="">
      {props.label}
    </button>
    </>
  );
