...
export default function PresenceCheckFixture(_props: PresenceCheckFixtureProps): JSX.Element {
  ...
  return (
    <>
    <div {...attrs} class={"presence-check-fixture" + (((attrs as unknown as Record<string, unknown>).class as string | undefined) ? " " + ((attrs as unknown as Record<string, unknown>).class as string | undefined) : "")} {...attrs} data-rozie-s-313bf282="">
