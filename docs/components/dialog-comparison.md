...
- [Dialog — live demo](/components/dialog-demo) — the real Vue package running in the page (backdrop / escape / programmatic close with a `@close` reason readout), plus the one `.rozie` source and the six generated outputs.
