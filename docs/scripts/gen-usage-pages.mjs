...
function renderPage(slug, name, usage, handle) {
  ...
  // Surface the per-demo `### ` sub-sections (e.g. data-table's 11 usage sets)
  // in the "On this page" outline — VitePress defaults to level 2 only, which
  // hides them. Single-snippet pages have no H3s, so this is a no-op for them.
